...
Optional: `RESEND_API_KEY`, `CRON_SECRET`, `ENCRYPTION_KEY`, `DAILY_API_KEY`, `STRIPE_SECRET_KEY`, `INNGEST_DEV`, `NEXT_PUBLIC_SENTRY_DSN`, `UPSTASH_REDIS_REST_URL`, `UPSTASH_REDIS_REST_TOKEN`
