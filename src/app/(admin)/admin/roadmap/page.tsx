...
const ROADMAP_ITEMS: RoadmapItem[] = [
  ...
  { id: "f07", name: "Gateway de pagamento", description: "Asaas (PIX, boleto, cartão de crédito), cobranças com parcelas, webhook de status", status: "done", priority: "important", effort: "high", category: "Financeiro" },
  ...
  { id: "i08", name: "Cache Redis (Upstash)", description: "Cache compartilhado entre instâncias serverless via Upstash Redis. Cache-aside com graceful degradation (fallback in-memory). Workspace config, dashboard stats, role resolution.", status: "done", priority: "important", effort: "medium", category: "Infraestrutura" },
  { id: "i09", name: "Rate limiting em gravações", description: "5 gravações/min por usuário + enforcement de limite mensal do plano (free: 30, pro: 300). Previne abuso de API Whisper/Claude.", status: "done", priority: "essential", effort: "low", category: "Infraestrutura" },
  { id: "i10", name: "Inngest: pipeline robusto", description: "Evento leve com referência (recordingId + audioPath), sem base64. Lookup direto por ID, sem placeholder frágil.", status: "done", priority: "important", effort: "medium", category: "Infraestrutura" },
  { id: "i11", name: "Monitoramento de audit log", description: "Sentry.captureException em falhas de escrita de audit log (CFM 1.821/2007). Non-blocking, mas visível no monitoring.", status: "done", priority: "important", effort: "low", category: "Infraestrutura" },
